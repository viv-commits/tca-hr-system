...
function sbH(){var k=SKEY;var tok=k;try{var r=(sessionStorage.getItem('sb-vhebrkhdgeiyxkpphlut-auth-token')||localStorage.getItem('sb-vhebrkhdgeiyxkpphlut-auth-token'));if(r){var p=JSON.parse(r);if(p&&p.access_token)tok=p.access_token;}}catch(e){}return{'Authorization':'Bearer '+tok,'apikey':k};}
